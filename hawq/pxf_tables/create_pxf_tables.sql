...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/categories_dim/categories_dim.tsv.gz?profile=HdfsTextSimple')
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/customers_dim/customers_dim.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/order_lineitems/order_lineitems.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/orders/orders.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/customer_addresses_dim/customer_addresses_dim.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/date_dim/date_dim.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/email_addresses_dim/email_addresses_dim.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/payment_methods/payment_methods.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
...
LOCATION ('pxf://sandbox.hortonworks.com:51200/retail_demo/products_dim/products_dim.tsv.gz?profile=HdfsTextSimple')
FORMAT 'TEXT' (DELIMITER = E'\t');
